...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp", function()
              awful.util.spawn("xbacklight -inc 4%") end),
    awful.key({ }, "XF86MonBrightnessDown", function()
              awful.util.spawn("xbacklight -dec 4%") end),

    -- Sound control
    awful.key({ }, "XF86AudioRaiseVolume", function()
              awful.util.spawn("sh -c 'amixer -q sset Master unmute && amixer -q sset Master 4%+'") end),
...
-- Autostart apps
awful.spawn.with_shell("picom -b -d :0")
awful.spawn.with_shell("nitrogen --set-scaled --random &")
awful.spawn.with_shell("nm-applet")
-- awful.spawn.with_shell("glava --desktop --force-mod=bars &")
