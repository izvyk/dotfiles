...
def get_current_layout_index(keyboard_name:str) -> int:
...
def convert(layout_from:str, layout_to:str) -> None:
...
def switch_layout_next(keyboard_name:str) -> None:
    subprocess.run(['hyprctl', '--quiet', 'switchxkblayout', keyboard_name, 'next'])
